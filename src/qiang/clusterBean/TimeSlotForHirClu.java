 ...
 *
 */
public class TimeSlotForHirClu {
...
//	}
	...
	public long dis(TimePointForHirClu point){
		return (point.timeBegin-this.timeIni)*(point.timeBegin-this.timeIni);
	}
	
	public long dis(TimeSlotForHirClu slot){
